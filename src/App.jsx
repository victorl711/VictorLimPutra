          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-6 py-2 rounded-xl border font-medium transition-all duration-300 ${
                filter === cat
                  ? "bg-[#7C4DFF] border-[#5729d6] text-white shadow-lg shadow-[#7C4DFF]/30"
          ...
          {filteredProyek.map((proyek) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col grow">
                ...
                <p className="text-gray-400 text-sm/relaxed mb-6 text-justify">
                  {proyek.desk}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-8 mt-auto">
                  {proyek.tools.map((tool, index) => (
                    <span
                      key={index}
                      className="text-[10px] font-medium px-2 py-1 rounded-md bg-[#1A2F4A] text-gray-300 border border-[#1E3B58]"
                    >
                      {tool}
                    </span>
                  ))}
                ...
                {/* Area Tombol dengan logika link2 */}
                <div className="flex gap-2">
                  <a
                    href={proyek.link}
                    target="_blank"
                    rel="noreferrer noopener"
                    className={`py-3 px-4 bg-[#7C4DFF] text-white font-semibold rounded-lg text-center hover:bg-[#6a3de0] transition-colors flex items-center justify-center gap-2 ${proyek.link2 ? 'w-1/2' : 'w-full'}`}
                  >
                    {proyek.link2 ? 'See Report' : 'See Detail'} <i className="ri-arrow-right-up-line"></i>
                  </a>
                  ...
                  {proyek.link2 && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer noopener" 
                      className="w-1/2 py-3 px-4 bg-[#1A2F4A] text-white font-semibold rounded-lg text-center border border-[#1E3B58] hover:bg-[#224A72] transition-colors flex items-center justify-center gap-2"
                    >
                      {proyek.teksLink2} <i className="ri-dashboard-line"></i>
                    </a>
                  )}
                </div>
              </div>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full bg-[#0A1A2F] border border-[#1E3B58] text-white rounded-lg p-3 focus:outline-none focus:border-[#7C4DFF] transition-all"
                required
              />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="w-full bg-[#0A1A2F] border border-[#1E3B58] text-white rounded-lg p-3 focus:outline-none focus:border-[#7C4DFF] transition-all resize-none"
                required
              ></textarea>
            </div>

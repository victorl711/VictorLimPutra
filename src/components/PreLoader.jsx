...
const PreLoader = ({ onFinish }) => {
  ...
  return (
    <div className="w-screen h-screen fixed top-0 left-0 flex flex-col gap-4 items-center justify-center bg-[#0a1a2f] z-50">

      {/* Loader SVG */}
      <div role="status">
        <svg
          aria-hidden="true"
          className="inline w-8 h-8 animate-spin fill-[#3b82f6] text-[#1e3a8a]"
          viewBox="0 0 100 101"
          fill="none"
...
22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 
